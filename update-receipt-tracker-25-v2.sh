#!/bin/bash
set -e
echo "Applying: short share links, Additional Tip (with reconciliation fix), cover-for-someone-else..."
...
npm test
echo "Now run: git add . && git commit -m \"Add short share links, Additional Tip, cover-for-someone-else\" && git push"
