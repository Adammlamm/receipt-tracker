#!/bin/bash
set -e
echo "Applying: everything from script 26, plus a Notes field on every receipt (visible to friends too)..."
...
npm test
echo "Now run: git add . && git commit -m \"Add receipt notes, full split options, short links, coverage\" && git push"
