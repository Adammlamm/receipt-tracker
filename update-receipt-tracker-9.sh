#!/bin/bash
set -e
echo "Applying: fix for whole-bill-evenly split showing zero per person..."
...
echo "Now run: git add . && git commit -m \"Fix whole-bill-evenly split showing zero per person\" && git push"
