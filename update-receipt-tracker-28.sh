#!/bin/bash
set -e
echo "Applying: everything from script 27, plus Unselect all / Just me buttons..."
...
npm test
echo "Now run: git add . && git commit -m \"Add Unselect all/Just me buttons, receipt notes, full split options\" && git push"
