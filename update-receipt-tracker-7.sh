#!/bin/bash
set -e
echo "Applying: PDF receipt support + item-level discounts (for BOGO/promo handling)..."
...
echo "Now run: git add . && git commit -m \"Add PDF support and item-level discounts\" && git push"
