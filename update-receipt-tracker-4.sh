#!/bin/bash
set -e
echo "Applying: rename/delete people, payment info, tip highlight, new split types, categories..."
...
mkdir -p $(dirname 'app/people/PersonRow.tsx')
...
echo "Now run: git add . && git commit -m \"Add rename/delete, payment info, tip highlight, split types, categories\" && git push"
